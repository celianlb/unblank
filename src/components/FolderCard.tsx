...
export default function FolderCard({
  ...
  const handleExit = async () => {
    try {
      // Si c'est un dossier dans un groupe partagé, on quitte le groupe parent
      ...
      alert("Erreur lors de la sortie du dossier/groupe");
    }
  };
  ...
  return (
    <>
      <div
        ...
        className="w-full h-full bg-white border-4 border-black rounded-[20px] flex-none cursor-pointer transition-shadow hover:shadow-[4px_4px_0px_#000000] box-border flex flex-col gap-4 p-3"
      >
