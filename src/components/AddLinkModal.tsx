        ...
        >
          <form onSubmit={handleSubmit} className="flex flex-col p-8 gap-6">
            ...
            <div className="flex flex-col gap-2">
              <label className="text-sm font-medium text-black font-[Heebo] font-medium">Lien</label>
              <input
                type="url"
                placeholder="URL"
                value={url}
            ...
            {/* Titre */}
            <div className="flex flex-col gap-2">
              <label className="text-sm font-medium text-black font-[Heebo] font-medium">Titre</label>
              <input
                type="text"
                placeholder="Titre"
                value={title}
            ...
            {/* Description */}
            <div className="flex flex-col gap-2">
              <label className="text-sm font-medium text-black font-[Heebo] font-medium">Description</label>
              <textarea
                placeholder=""
                value={description}
            ...
            <button
              type="submit"
              className="w-full h-14 rounded-xl bg-[#FF506F] hover:bg-[#FF6080] transition-colors border-2 border-black shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] text-black font-bold text-base cursor-pointer font-[Heebo]"
            >
              Ajouter le lien
            </button>
          </form>
